...
echo Open http://127.0.0.1:8501/ in your browser if it does not open automatically.
python -m streamlit run "dashboard_app\app.py" --server.port 8501 --server.address 127.0.0.1
